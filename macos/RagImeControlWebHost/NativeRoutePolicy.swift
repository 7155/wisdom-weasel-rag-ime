...
final class NativeRoutePolicy {
    ...
    private static let routes: [String: NativeRouteDefinition] = {
        ...
        return [
            ...
            "agent.memoryMaintenance.trigger": route("POST", "/api/agent/memory-maintenance", "/control/v1/agent/memory-maintenance", bodyKeys: ["project", "ownerKind", "ownerId", "instruction", "manual", "maxSources", "autoApply", "drainAll", "catalogAudit"]),
