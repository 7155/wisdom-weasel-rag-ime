...
final class NativeRoutePolicy {
    ...
    private static let routes: [String: NativeRouteDefinition] = {
        ...
        return [
            ...
            "agent.room.kernel.settle": route("POST", "/api/agent/rooms/{roomId}/kernel/settle", "/control/v1/agent/rooms/{roomId}/kernel/settle", remoteSafe: true, bodyKeys: ["settleReceipt", "commit", "invocationReceiptId"], requiredBodyKeys: ["settleReceipt", "commit"]),
