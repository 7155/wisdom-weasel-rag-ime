...
final class NativeRoutePolicy {
    ...
    private static let routes: [String: NativeRouteDefinition] = {
        ...
        return [
            ...
            "input.prediction.liveTrace": route("GET", "/api/prediction/live-trace", nil, query: ["limit", "sessionId"]),
            "observability.snapshot": route("GET", "/api/observability/snapshot", "/control/v1/observability/snapshot", query: ["limit", "beforeSequence", "sessionId", "roomId", "traceId", "runId", "category", "status"], remoteSafe: true),
            "observability.trace.get": route("GET", "/api/observability/traces/{traceId}", "/control/v1/observability/traces/{traceId}", query: ["limit", "beforeSequence"], remoteSafe: true),
            "observability.evals.list": route("GET", "/api/observability/evals", "/control/v1/observability/evals", query: ["traceId", "limit"], requiredQuery: ["traceId"], remoteSafe: true),
            "observability.evalSuites.list": route("GET", "/api/observability/eval-suites", "/control/v1/observability/eval-suites", query: ["limit"], remoteSafe: true),
            "observability.sandboxRuns.list": route("GET", "/api/observability/sandbox-runs", "/control/v1/observability/sandbox-runs", query: ["limit"], remoteSafe: true),
            "observability.sandboxRun.get": route("GET", "/api/observability/sandbox-runs/{sandboxRunId}", "/control/v1/observability/sandbox-runs/{sandboxRunId}", remoteSafe: true),
            "observability.evals.evidence.run": route("POST", "/api/observability/evals/evidence-ground-truth", nil, bodyKeys: ["schemaVersion", "traceId", "requiredEvidenceIds", "datasetId", "labelRevision", "truthKind"], requiredBodyKeys: ["schemaVersion", "traceId", "requiredEvidenceIds", "datasetId", "labelRevision", "truthKind"]),
            "observability.evalSchedules.list": route("GET", "/api/observability/eval-schedules", nil, query: ["limit"]),
            "observability.evalSchedules.create": route("POST", "/api/observability/eval-schedules", nil, bodyKeys: ["scheduleId", "suiteId", "suiteRevision", "recurrenceKind", "recurrenceInterval", "maxRuns", "nextDueAtMs"], requiredBodyKeys: ["suiteId", "suiteRevision", "recurrenceKind", "nextDueAtMs"]),
            "observability.evalSchedule.runs": route("GET", "/api/observability/eval-schedules/{scheduleId}/runs", nil, query: ["limit"]),
            "observability.events": route("GET", "/api/observability/events", "/control/v1/observability/events", query: ["sessionId", "roomId", "traceId", "runId", "category", "status"], remoteSafe: true, subscription: true),
            ...
            "agent.session.capability-policy.update": route("PATCH", "/api/agent/sessions/{sessionId}", "/control/v1/agent/sessions/{sessionId}", remoteSafe: true, bodyKeys: ["capabilityDisclosurePreferences"], requiredBodyKeys: ["capabilityDisclosurePreferences"]),
            ...
            "agent.session.forks.list": route("GET", "/api/agent/sessions/{sessionId}/forks", "/control/v1/agent/sessions/{sessionId}/forks", remoteSafe: true, requiresGateway: true),
            "agent.session.forks.create": route("POST", "/api/agent/sessions/{sessionId}/forks", "/control/v1/agent/sessions/{sessionId}/forks", remoteSafe: true, bodyKeys: ["entryId", "title"], requiredBodyKeys: ["entryId"], requiresGateway: true),
            ...
            "agent.session.ui.resolve": route("POST", "/api/agent/sessions/{sessionId}/ui-response", "/control/v1/agent/sessions/{sessionId}/ui-response", bodyKeys: ["requestId", "value", "confirmed", "cancelled", "resolutionSource"], requiredBodyKeys: ["requestId"]),
            ...
            "agent.session.command.invoke": route("POST", "/api/agent/sessions/{sessionId}/commands", "/control/v1/agent/sessions/{sessionId}/commands", remoteSafe: true, bodyKeys: ["command"], requiredBodyKeys: ["command"]),
            ...
            "agent.session.backgroundJobs.list": route("GET", "/api/agent/sessions/{sessionId}/background-jobs", "/control/v1/agent/sessions/{sessionId}/background-jobs", query: ["limit", "status"]),
            "agent.session.backgroundJob.get": route("GET", "/api/agent/sessions/{sessionId}/background-jobs/{jobId}", "/control/v1/agent/sessions/{sessionId}/background-jobs/{jobId}"),
            "agent.session.backgroundJob.logs": route("GET", "/api/agent/sessions/{sessionId}/background-jobs/{jobId}/logs", "/control/v1/agent/sessions/{sessionId}/background-jobs/{jobId}/logs", query: ["cursor", "limitBytes"]),
            "agent.session.backgroundJob.cancel": route("POST", "/api/agent/sessions/{sessionId}/background-jobs/{jobId}/cancel", "/control/v1/agent/sessions/{sessionId}/background-jobs/{jobId}/cancel", bodyKeys: ["reason"]),
            ...
            "agent.session.goal.mutate": route("POST", "/api/agent/sessions/{sessionId}/goal", "/control/v1/agent/sessions/{sessionId}/goal", remoteSafe: true, bodyKeys: ["action", "expectedRevision", "confirmed", "objective", "successCriteria", "evidenceExpectations", "tokenBudget", "timeBudgetMs", "summary", "reason", "evidence"], requiredBodyKeys: ["action"]),
            ...
            "agent.media.preview": route("GET", "/api/agent/media/{mediaId}/preview", "/control/v1/agent/media/{mediaId}/preview", query: ["sessionId", "sha256"], requiredQuery: ["sessionId"], remoteSafe: true),
            ...
            "agent.rooms.create": route("POST", "/api/agent/rooms", "/control/v1/agent/rooms", remoteSafe: true, bodyKeys: ["title", "roomKind", "avatar", "description", "scenarioPrompt", "participants", "routingPolicy", "routingConfig", "moderatorRoleId", "workspaceRoots", "executionMode", "workspaceScopeConfirmation", "dangerousModeConfirmation"], requiredBodyKeys: ["participants"]),
            ...
            "agent.room.history": route("GET", "/api/agent/rooms/{roomId}/history", "/control/v1/agent/rooms/{roomId}/history", query: ["beforeSequence", "limit"], remoteSafe: true),
            "agent.room.archive": route("PATCH", "/api/agent/rooms/{roomId}", "/control/v1/agent/rooms/{roomId}", remoteSafe: true, bodyKeys: ["archived", "title", "roomKind", "avatar", "description", "scenarioPrompt", "routingPolicy", "routingConfig", "moderatorParticipantId", "executionMode", "workspaceScopeConfirmation", "dangerousModeConfirmation"]),
            "agent.room.participant.add": route("POST", "/api/agent/rooms/{roomId}/participants", "/control/v1/agent/rooms/{roomId}/participants", remoteSafe: true, bodyKeys: ["roleId", "roleVersion", "collaborationRole"], requiredBodyKeys: ["roleId"]),
            ...
            "agent.room.participant.update": route("PATCH", "/api/agent/rooms/{roomId}/participants", "/control/v1/agent/rooms/{roomId}/participants", remoteSafe: true, bodyKeys: ["participantId", "collaborationRole"], requiredBodyKeys: ["participantId", "collaborationRole"]),
            "agent.room.delete": route("DELETE", "/api/agent/rooms/{roomId}", nil, bodyKeys: ["confirmTitle"], requiredBodyKeys: ["confirmTitle"]),
            "agent.room.message": route("POST", "/api/agent/rooms/{roomId}/messages", "/control/v1/agent/rooms/{roomId}/messages", remoteSafe: true, bodyKeys: ["message", "clientMessageId", "participantIds", "workItemId", "attachmentIds", "answerToPostId", "answerToRootId"], requiredBodyKeys: ["message"]),
            "agent.room.participant.steer": route("POST", "/api/agent/rooms/{roomId}/steer", "/control/v1/agent/rooms/{roomId}/steer", remoteSafe: true, bodyKeys: ["action", "rootId", "participantId", "clientActionId", "message"], requiredBodyKeys: ["action", "rootId", "clientActionId", "message"]),
            ...
            "agent.collaborationProfile.get": route("GET", "/api/agent/collaboration-profiles/{profileId}", "/control/v1/agent/collaboration-profiles/{profileId}", remoteSafe: true),
            "agent.collaborationProfile.command": route("POST", "/api/agent/collaboration-profiles/commands", "/control/v1/agent/collaboration-profiles/commands", remoteSafe: true, bodyKeys: ["schemaVersion", "commandId", "action", "idempotencyKey", "actorRef", "profileId", "candidateId", "contentHash", "expectedPointerRevision", "activationScope", "adminConfirmation", "payload", "createdAtMs"], requiredBodyKeys: ["schemaVersion", "commandId", "action", "idempotencyKey", "actorRef", "payload", "createdAtMs"]),
            "agent.knowledge.search": route("POST", "/api/agent/sessions/{sessionId}/knowledge-search", "/control/v1/agent/sessions/{sessionId}/knowledge-search", remoteSafe: true, bodyKeys: ["query", "limit", "retrievalReceiptId", "createdAtMs"], requiredBodyKeys: ["query"]),
            "agent.governance.read": route("GET", "/api/agent/governance", "/control/v1/agent/governance", query: ["scopeKey"], remoteSafe: true),
            "agent.knowledgeGovernance.read": route("GET", "/api/agent/knowledge-governance", "/control/v1/agent/knowledge-governance", remoteSafe: true),
            "agent.knowledge.read": route("POST", "/api/agent/sessions/{sessionId}/knowledge-read", "/control/v1/agent/sessions/{sessionId}/knowledge-read", remoteSafe: true, bodyKeys: ["retrievalReceiptId", "claimRef", "expectedHash"], requiredBodyKeys: ["retrievalReceiptId", "claimRef", "expectedHash"]),
            ...
            "agent.room.workItem.resume": route("POST", "/api/agent/rooms/{roomId}/work-items/{workItemId}/resume", nil, bodyKeys: ["actorParticipantId", "clientActionId", "phase", "timeoutSeconds"], requiredBodyKeys: ["actorParticipantId"]),
            "agent.roles.list": route("GET", "/api/agent/roles", "/control/v1/agent/roles", remoteSafe: true),
            "agent.roles.create": route("POST", "/api/agent/roles", "/control/v1/agent/roles", remoteSafe: true, bodyKeys: ["displayName", "tagline", "summary", "traits", "timelineModel", "selectableModes", "suitableTasks", "unsuitableTasks"], requiredBodyKeys: ["displayName", "tagline", "summary", "traits", "timelineModel", "selectableModes", "suitableTasks", "unsuitableTasks"]),
            "agent.roles.update": route("PATCH", "/api/agent/roles", "/control/v1/agent/roles", remoteSafe: true, bodyKeys: ["roleId", "roleVersion", "displayName", "tagline", "summary", "traits", "timelineModel", "selectableModes", "suitableTasks", "unsuitableTasks"], requiredBodyKeys: ["roleId", "roleVersion", "displayName", "tagline", "summary", "traits", "timelineModel", "selectableModes", "suitableTasks", "unsuitableTasks"]),
            "agent.roles.archive": route("DELETE", "/api/agent/roles", "/control/v1/agent/roles", remoteSafe: true, bodyKeys: ["roleId", "roleVersion"], requiredBodyKeys: ["roleId", "roleVersion"]),
            ...
            "agent.extensions.usage": route("GET", "/api/agent/extensions/usage", nil, query: ["packageId", "resourceKind", "sessionId", "sinceMs", "limit"]),
            "agent.extensions.catalog": route("GET", "/api/agent/extensions/catalog", "/control/v1/agent/extensions/catalog"),
            ...
            "agent.extensions.validate": route("POST", "/api/agent/extensions/validate", "/control/v1/agent/extensions/validate", bodyKeys: ["sourcePath", "catalogId", "catalogVersion"]),
            ...
            "agent.lifecycleHooks.get": route("GET", "/api/agent/lifecycle-hooks", "/control/v1/agent/lifecycle-hooks", query: ["limit"]),
            "agent.lifecycleHooks.update": route("PATCH", "/api/agent/lifecycle-hooks", "/control/v1/agent/lifecycle-hooks", bodyKeys: ["eventType", "enabled", "action", "tokenLimit", "cooldownSeconds"], requiredBodyKeys: ["eventType"]),
            "agent.approvals.list": route("GET", "/api/agent/approvals", "/control/v1/agent/approvals", query: ["sessionId", "state", "limit"], remoteSafe: true),
            ...
            "agent.memoryMaintenance.run": route("GET", "/api/agent/memory-maintenance", "/control/v1/agent/memory-maintenance", query: ["runId", "jobId", "project", "limit"]),
            "agent.memoryMaintenance.trigger": route("POST", "/api/agent/memory-maintenance", "/control/v1/agent/memory-maintenance", bodyKeys: ["project", "ownerKind", "ownerId", "instruction", "manual", "maxSources"]),
            ...
            "agent.subagents.create": route("POST", "/api/agent/subagents/runs", "/control/v1/agent/subagents/runs", remoteSafe: true, bodyKeys: ["sessionId", "tasks", "agent", "version", "task", "expectedOutput", "acceptanceCriteria", "outputSchema", "modelProfile", "thinkingLevel", "access", "allowedTools", "piSkillsEnabled", "codexSkillsEnabled", "workspaceRoots", "todoTask", "contextMode", "forkEntryId", "wait"], requiredBodyKeys: ["sessionId"]),
            ...
            "agent.subagent.console": route("GET", "/api/agent/subagents/runs/{runId}/console", "/control/v1/agent/subagents/runs/{runId}/console", query: ["sessionId"], requiredQuery: ["sessionId"], remoteSafe: true),
            "agent.subagent.control": route("POST", "/api/agent/subagents/runs/{runId}/control", "/control/v1/agent/subagents/runs/{runId}/control", remoteSafe: true, bodyKeys: ["sessionId", "action", "clientActionId", "message", "inboxId"], requiredBodyKeys: ["sessionId", "action", "clientActionId"]),
            ...
            "browser.command": route("POST", "/api/browser/command", "/control/v1/browser/command", bodyKeys: ["action", "deviceId", "tabId", "refId", "url", "text", "script", "clear", "submit", "direction", "amount", "timeoutMs", "timeoutSeconds"], requiredBodyKeys: ["action"]),
            ...
            "terminal.sessions.list": route("GET", "/api/terminal/sessions", "/control/v1/terminal/sessions"),
            "terminal.session.create": route("POST", "/api/terminal/sessions", "/control/v1/terminal/sessions", bodyKeys: ["title", "cwd", "shell", "cols", "rows"]),
            "terminal.session.read": route("POST", "/api/terminal/read", "/control/v1/terminal/read", bodyKeys: ["terminalId", "cursor", "maxBytes"], requiredBodyKeys: ["terminalId"]),
            "terminal.session.write": route("POST", "/api/terminal/write", "/control/v1/terminal/write", bodyKeys: ["terminalId", "text"], requiredBodyKeys: ["terminalId", "text"]),
            "terminal.session.resize": route("POST", "/api/terminal/resize", "/control/v1/terminal/resize", bodyKeys: ["terminalId", "cols", "rows"], requiredBodyKeys: ["terminalId", "cols", "rows"]),
            "terminal.session.close": route("POST", "/api/terminal/close", "/control/v1/terminal/close", bodyKeys: ["terminalId"], requiredBodyKeys: ["terminalId"]),
            ...
            "workDocuments.list": route("GET", "/api/agent/work-documents", nil, query: ["limit"]),
            "workDocuments.history.search": route("GET", "/api/agent/work-documents/history/search", nil, query: ["query", "limit"]),
            "workDocuments.get": route("GET", "/api/agent/work-documents/{documentId}", nil),
            "workDocuments.register": route("POST", "/api/agent/work-documents", nil, bodyKeys: ["authorityKind", "authorityId", "authorityRevision", "workspaceRoot", "sourcePath", "title"], requiredBodyKeys: ["authorityKind", "authorityId", "authorityRevision", "workspaceRoot", "sourcePath"]),
            "workDocuments.archive": route("POST", "/api/agent/work-documents/{documentId}/archive", nil, bodyKeys: ["terminalReceiptId"], requiredBodyKeys: ["terminalReceiptId"]),
            "workDocuments.repair": route("POST", "/api/agent/work-documents/{documentId}/repair", nil),
            "workDocuments.reopen": route("POST", "/api/agent/work-documents/{documentId}/reopen", nil, bodyKeys: ["authorityRevision", "transitionReceiptId"], requiredBodyKeys: ["authorityRevision", "transitionReceiptId"]),
            "workDocuments.erase.preview": route("POST", "/api/agent/work-documents/{documentId}/erase-preview", nil, bodyKeys: ["sessionId"], requiredBodyKeys: ["sessionId"]),
            "workDocuments.erase": route("POST", "/api/agent/work-documents/{documentId}/erase", nil, bodyKeys: ["sessionId", "approvalId", "payloadSha256"], requiredBodyKeys: ["sessionId", "approvalId", "payloadSha256"]),
            ...
            "memory.source.disposition": route("POST", "/api/memory/source/disposition", "/control/v1/memory/source/disposition", bodyKeys: ["sourceId", "evidenceId", "disposition"], requiredBodyKeys: ["disposition"]),
            ...
            "memory.activityTimeline.calendar": route("GET", "/api/memory/activity-timeline/calendar", "/control/v1/memory/activity-timeline/calendar", query: ["month"], requiredQuery: ["month"], remoteSafe: true),
            "memory.activityTimeline.build": route("POST", "/api/memory/activity-timeline/build", "/control/v1/memory/activity-timeline/build", remoteSafe: true, bodyKeys: ["date", "throughToday"], requiredBodyKeys: ["date"]),
            ...
            "knowledgeEmbedding.profile": route("GET", "/api/knowledge-bases/embedding-profile", nil),
            "knowledgeEmbedding.probe": route("POST", "/api/knowledge-bases/embedding-probe", nil, bodyKeys: ["profile"], requiredBodyKeys: ["profile"]),
            "knowledgeEmbedding.impact": route("POST", "/api/knowledge-bases/embedding-impact", nil, bodyKeys: ["profile"], requiredBodyKeys: ["profile"]),
