...
final class NativeRoutePolicy {
    ...
    private static let routes: [String: NativeRouteDefinition] = {
        ...
        return [
            ...
            "agent.room.message": route("POST", "/api/agent/rooms/{roomId}/messages", "/control/v1/agent/rooms/{roomId}/messages", remoteSafe: true, bodyKeys: ["message", "clientMessageId", "participantIds", "workItemId", "attachmentIds"], requiredBodyKeys: ["message"]),
            "agent.room.startExecution": route("POST", "/api/agent/rooms/{roomId}/start-execution", "/control/v1/agent/rooms/{roomId}/start-execution", remoteSafe: true, bodyKeys: ["action", "rootId", "clientActionId"], requiredBodyKeys: ["action", "rootId", "clientActionId"]),
            ...
            "agent.room.kernel.command": route("POST", "/api/agent/rooms/{roomId}/kernel/commands", "/control/v1/agent/rooms/{roomId}/kernel/commands", remoteSafe: true, bodyKeys: ["schemaVersion", "commandId", "rootId", "roomId", "commandKind", "targetKind", "targetId", "sourceKind", "sourceId", "idempotencyKey", "generation", "payload", "createdAtMs"], requiredBodyKeys: ["schemaVersion", "commandId", "roomId", "commandKind", "sourceKind", "sourceId", "idempotencyKey", "generation", "payload", "createdAtMs"]),
            "agent.room.kernel.settle": route("POST", "/api/agent/rooms/{roomId}/kernel/settle", "/control/v1/agent/rooms/{roomId}/kernel/settle", remoteSafe: true, bodyKeys: ["settleReceipt", "commit", "invocationReceiptId"], requiredBodyKeys: ["settleReceipt"]),
            "agent.room.kernel.create": route("POST", "/api/agent/rooms/{roomId}/kernel/create", "/control/v1/agent/rooms/{roomId}/kernel/create", remoteSafe: true, bodyKeys: ["rootExecution", "task", "budget", "maxHops", "maxDepth", "acceptanceCriteria"], requiredBodyKeys: ["rootExecution", "task", "budget", "maxHops", "maxDepth"]),
            "agent.room.kernel.dispatch": route("POST", "/api/agent/rooms/{roomId}/kernel/dispatch", "/control/v1/agent/rooms/{roomId}/kernel/dispatch", remoteSafe: true, bodyKeys: ["schemaVersion", "dispatchId", "rootId", "taskId", "parentDispatchId", "generation", "hopCount", "depth", "budgetCost", "targetSessionId", "targetParticipantId", "triggerId", "intentKind", "idempotencyKey", "attempt", "capabilityEpoch", "runtimeProfileRevision", "state"], requiredBodyKeys: ["schemaVersion", "dispatchId", "rootId", "taskId", "generation", "hopCount", "depth", "budgetCost", "targetSessionId", "targetParticipantId", "triggerId", "intentKind", "idempotencyKey", "attempt", "capabilityEpoch", "runtimeProfileRevision", "state"]),
            "agent.room.kernel.finalize": route("POST", "/api/agent/rooms/{roomId}/kernel/finalize", "/control/v1/agent/rooms/{roomId}/kernel/finalize", remoteSafe: true, bodyKeys: ["rootId", "catalogRevisionId", "targetCommit", "blindReviewStatus", "deliveryGatePreviewReceiptId"], requiredBodyKeys: ["rootId"]),
