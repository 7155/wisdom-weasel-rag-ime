...
env_vars = {
    ...
    "RAG_IME_AUTO_PREDICT_IDLE_MS": os.environ.get("RAG_IME_AUTO_PREDICT_IDLE_MS", "420"),
    "RAG_IME_AUTO_PREDICT_MIN_DELTA_CHARS": os.environ.get("RAG_IME_AUTO_PREDICT_MIN_DELTA_CHARS", "8"),
    "RAG_IME_AUTO_PREDICT_MAX_CALLS_PER_10S": os.environ.get("RAG_IME_AUTO_PREDICT_MAX_CALLS_PER_10S", "2"),
    "RAG_IME_AUTO_PREDICT_IGNORE_COOLDOWN_MS": os.environ.get("RAG_IME_AUTO_PREDICT_IGNORE_COOLDOWN_MS", "2500"),
