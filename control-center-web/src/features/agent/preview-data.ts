...
export const previewPersonas: AgentPersonaV1[] = [
  {
    schemaVersion: 'rag-ime.agent-persona.v1', roleId: 'vcp-v1', version: '1',
  ...
  {
    schemaVersion: 'rag-ime.agent-persona.v1', roleId: 'flash-v1', version: '1',
    ...
    runtimeCharacteristics: { intelligence: '中高', speed: '极速', context: '超长上下文，擅长高速扫描', suitableTasks: ['长材料扫读与线索提取', '归类、去重和结构化整理'], unsuitableTasks: ['复杂实现', '高风险决定', '独立最终验收'], isDefault: false },
    safetyPolicyVersion: 'control-center-safe-v1', selectableModes: ['assistant', 'coordinator'],
  },
];
