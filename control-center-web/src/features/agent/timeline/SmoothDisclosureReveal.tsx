...
/* One disclosure voice across the conversation: the baseline's gentle spring
   (--paw-chat-spring) shared by every reveal (.agent-smooth-reveal,
   .agent-turn-work__reveal, .paw-activity__detail). The duration also bounds
   the fallback finish timer. */
