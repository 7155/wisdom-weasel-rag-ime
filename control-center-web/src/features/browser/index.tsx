...
export function BrowserFeature() {
  ...
  const screenshotUrl = pageSnapshot.hasScreenshot === true && stringValue(pageSnapshot.snapshotId)
    ? `http://127.0.0.1:8766/api/browser/snapshots/${encodeURIComponent(stringValue(pageSnapshot.snapshotId))}/image`
    : '';
    ...
    <section className="browser-setup">
      <div className="browser-setup__section">
        ...
        <dl>
          ...
          <div><dt>桥接地址</dt><dd>{stringValue(pairing.bridgeUrl, 'http://127.0.0.1:8766')}</dd></div>
