...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.KNOWLEDGE_BASES_GRAPH_REBUILD, ControlMethod.POST, "/api/knowledge-bases/{kbId}/graph/rebuild", None, params=_KNOWLEDGE_BASE, body={"expectedRevision", "documentIds"}, required_body={"expectedRevision"}),
