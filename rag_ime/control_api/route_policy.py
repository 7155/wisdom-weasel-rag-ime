...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.AGENT_MEMORY_MAINTENANCE_TRIGGER, ControlMethod.POST, "/api/agent/memory-maintenance", "/control/v1/agent/memory-maintenance", body={"project", "ownerKind", "ownerId", "instruction", "manual", "maxSources", "autoApply", "drainAll", "catalogAudit"}),
