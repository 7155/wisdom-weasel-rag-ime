...
class ControlPathId(str, Enum):
    ...
    AGENT_SESSION_WORKSPACE_WRITE = "agent.session.workspace.write"
...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.AGENT_SESSION_WORKSPACE_WRITE, ControlMethod.POST, "/api/agent/sessions/{sessionId}/workspace-file", None, params=_SESSION, body={"path", "resourceRevision", "content"}, required_body={"path", "resourceRevision", "content"}),
