...
class ControlPathId(str, Enum):
    ...
    AGENT_ROOM_START_EXECUTION = "agent.room.startExecution"
    ...
    AGENT_ROOM_KERNEL_SNAPSHOT = "agent.room.kernel.snapshot"
    AGENT_ROOM_KERNEL_EVENTS = "agent.room.kernel.events"
    AGENT_ROOM_KERNEL_COMMAND = "agent.room.kernel.command"
    AGENT_ROOM_KERNEL_SETTLE = "agent.room.kernel.settle"
    AGENT_ROOM_KERNEL_CREATE = "agent.room.kernel.create"
    AGENT_ROOM_KERNEL_DISPATCH = "agent.room.kernel.dispatch"
    AGENT_ROOM_KERNEL_FINALIZE = "agent.room.kernel.finalize"
    ...
    AGENT_ROLES_ARCHIVE = "agent.roles.archive"
    ...
    AGENT_MEMORY_MAINTENANCE_TRIGGER = "agent.memoryMaintenance.trigger"
    ...
    KNOWLEDGE_EMBEDDING_PROFILE = "knowledgeEmbedding.profile"
    KNOWLEDGE_EMBEDDING_PROBE = "knowledgeEmbedding.probe"
    KNOWLEDGE_EMBEDDING_IMPACT = "knowledgeEmbedding.impact"
...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.AGENT_ROOM_KERNEL_SNAPSHOT, ControlMethod.GET, "/api/agent/rooms/{roomId}/kernel/snapshot", "/control/v1/agent/rooms/{roomId}/kernel/snapshot", scopes=[ControlScope.AGENT_READ], remote_safe=True, params=_ROOM),
        _route(ControlPathId.AGENT_ROOM_KERNEL_EVENTS, ControlMethod.GET, "/api/agent/rooms/{roomId}/kernel/events", "/control/v1/agent/rooms/{roomId}/kernel/events", scopes=[ControlScope.AGENT_READ], remote_safe=True, subscription=True, params=_ROOM, query=_LAST_EVENT_QUERY, required_query=_LAST_EVENT_QUERY),
        _route(ControlPathId.AGENT_ROOM_KERNEL_COMMAND, ControlMethod.POST, "/api/agent/rooms/{roomId}/kernel/commands", "/control/v1/agent/rooms/{roomId}/kernel/commands", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"schemaVersion", "commandId", "rootId", "roomId", "commandKind", "targetKind", "targetId", "sourceKind", "sourceId", "idempotencyKey", "generation", "payload", "createdAtMs"}, required_body={"schemaVersion", "commandId", "roomId", "commandKind", "sourceKind", "sourceId", "idempotencyKey", "generation", "payload", "createdAtMs"}, remote_body={"schemaVersion", "commandId", "rootId", "roomId", "commandKind", "targetKind", "targetId", "sourceKind", "sourceId", "idempotencyKey", "generation", "payload", "createdAtMs"}, remote_required_body={"schemaVersion", "commandId", "roomId", "commandKind", "sourceKind", "sourceId", "idempotencyKey", "generation", "payload", "createdAtMs"}),
        _route(ControlPathId.AGENT_ROOM_KERNEL_SETTLE, ControlMethod.POST, "/api/agent/rooms/{roomId}/kernel/settle", "/control/v1/agent/rooms/{roomId}/kernel/settle", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"settleReceipt", "commit", "invocationReceiptId"}, required_body={"settleReceipt"}, remote_body={"settleReceipt", "commit", "invocationReceiptId"}, remote_required_body={"settleReceipt"}),
        _route(ControlPathId.AGENT_ROOM_KERNEL_CREATE, ControlMethod.POST, "/api/agent/rooms/{roomId}/kernel/create", "/control/v1/agent/rooms/{roomId}/kernel/create", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"rootExecution", "task", "budget", "maxHops", "maxDepth", "acceptanceCriteria"}, required_body={"rootExecution", "task", "budget", "maxHops", "maxDepth"}, remote_body={"rootExecution", "task", "budget", "maxHops", "maxDepth", "acceptanceCriteria"}, remote_required_body={"rootExecution", "task", "budget", "maxHops", "maxDepth"}),
        _route(ControlPathId.AGENT_ROOM_KERNEL_DISPATCH, ControlMethod.POST, "/api/agent/rooms/{roomId}/kernel/dispatch", "/control/v1/agent/rooms/{roomId}/kernel/dispatch", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"schemaVersion", "dispatchId", "rootId", "taskId", "parentDispatchId", "generation", "hopCount", "depth", "budgetCost", "targetSessionId", "targetParticipantId", "triggerId", "intentKind", "idempotencyKey", "attempt", "capabilityEpoch", "runtimeProfileRevision", "state"}, required_body={"schemaVersion", "dispatchId", "rootId", "taskId", "generation", "hopCount", "depth", "budgetCost", "targetSessionId", "targetParticipantId", "triggerId", "intentKind", "idempotencyKey", "attempt", "capabilityEpoch", "runtimeProfileRevision", "state"}, remote_body={"schemaVersion", "dispatchId", "rootId", "taskId", "parentDispatchId", "generation", "hopCount", "depth", "budgetCost", "targetSessionId", "targetParticipantId", "triggerId", "intentKind", "idempotencyKey", "attempt", "capabilityEpoch", "runtimeProfileRevision", "state"}, remote_required_body={"schemaVersion", "dispatchId", "rootId", "taskId", "generation", "hopCount", "depth", "budgetCost", "targetSessionId", "targetParticipantId", "triggerId", "intentKind", "idempotencyKey", "attempt", "capabilityEpoch", "runtimeProfileRevision", "state"}),
        _route(ControlPathId.AGENT_ROOM_KERNEL_FINALIZE, ControlMethod.POST, "/api/agent/rooms/{roomId}/kernel/finalize", "/control/v1/agent/rooms/{roomId}/kernel/finalize", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"rootId", "catalogRevisionId", "targetCommit", "blindReviewStatus", "deliveryGatePreviewReceiptId"}, required_body={"rootId"}, remote_body={"rootId", "catalogRevisionId", "targetCommit", "blindReviewStatus", "deliveryGatePreviewReceiptId"}, remote_required_body={"rootId"}),
        ...
        _route(ControlPathId.AGENT_KNOWLEDGE_SEARCH, ControlMethod.POST, "/api/agent/sessions/{sessionId}/knowledge-search", "/control/v1/agent/sessions/{sessionId}/knowledge-search", scopes=[ControlScope.AGENT_READ], remote_safe=True, params=_SESSION, body={"query", "limit", "retrievalReceiptId", "createdAtMs"}, required_body={"query"}, remote_body={"query", "limit", "retrievalReceiptId", "createdAtMs"}, remote_required_body={"query"}),
        ...
        _route(ControlPathId.AGENT_ROOM_START_EXECUTION, ControlMethod.POST, "/api/agent/rooms/{roomId}/start-execution", "/control/v1/agent/rooms/{roomId}/start-execution", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"action", "rootId", "clientActionId"}, required_body={"action", "rootId", "clientActionId"}, remote_body={"action", "rootId", "clientActionId"}, remote_required_body={"action", "rootId", "clientActionId"}, remote_body_values={"action": {"start_execution"}}),
        _route(ControlPathId.AGENT_ROOM_PARTICIPANT_STEER, ControlMethod.POST, "/api/agent/rooms/{roomId}/steer", "/control/v1/agent/rooms/{roomId}/steer", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"action", "rootId", "expectedGeneration", "participantId", "clientActionId", "message"}, required_body={"action", "rootId", "expectedGeneration", "participantId", "clientActionId", "message"}, remote_body={"action", "rootId", "expectedGeneration", "participantId", "clientActionId", "message"}, remote_required_body={"action", "rootId", "expectedGeneration", "participantId", "clientActionId", "message"}, remote_body_values={"action": {"steer_participant"}}),
        ...
        _route(ControlPathId.AGENT_ROLES_ARCHIVE, ControlMethod.DELETE, "/api/agent/roles", "/control/v1/agent/roles", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, body={"roleId", "roleVersion"}, required_body={"roleId", "roleVersion"}, remote_body={"roleId", "roleVersion"}),
        ...
        _route(ControlPathId.AGENT_ROLE_RUNTIME_DEFAULTS_UPDATE, ControlMethod.POST, "/api/agent/roles/runtime-defaults", "/control/v1/agent/roles/runtime-defaults", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, body={"roleId", "roleVersion", "provider", "modelId", "thinkingLevel"}, required_body={"roleId", "roleVersion", "provider", "modelId", "thinkingLevel"}, remote_body={"roleId", "roleVersion", "provider", "modelId", "thinkingLevel"}, remote_body_values={"thinkingLevel": {"minimal", "low", "medium", "high", "xhigh", "max"}}),
        ...
        _route(ControlPathId.AGENT_ROLE_BOOK_ACTIVATION_PREVIEW, ControlMethod.POST, "/api/agent/role-book/activation/preview", "/control/v1/agent/role-book/activation/preview", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, body={"roleId", "roleVersion", "revisionId", "draftId", "traitIndexes", "capabilityIndexes", "lessonIndexes", "commitmentIndexes"}, required_body={"roleId", "roleVersion"}, remote_body={"roleId", "roleVersion", "revisionId", "draftId", "traitIndexes", "capabilityIndexes", "lessonIndexes", "commitmentIndexes"}),
        _route(ControlPathId.AGENT_ROLE_BOOK_ACTIVATION_APPLY, ControlMethod.POST, "/api/agent/role-book/activation/apply", "/control/v1/agent/role-book/activation/apply", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, body={"roleId", "roleVersion", "revisionId", "draftId", "traitIndexes", "capabilityIndexes", "lessonIndexes", "commitmentIndexes", "previewToken", "payloadSha256", "confirmText"}, required_body={"roleId", "roleVersion", "previewToken", "payloadSha256", "confirmText"}, remote_body={"roleId", "roleVersion", "revisionId", "draftId", "traitIndexes", "capabilityIndexes", "lessonIndexes", "commitmentIndexes", "previewToken", "payloadSha256", "confirmText"}, remote_body_values={"confirmText": {"apply"}}),
        ...
        _route(ControlPathId.AGENT_MEMORY_MAINTENANCE_RUN, ControlMethod.GET, "/api/agent/memory-maintenance", "/control/v1/agent/memory-maintenance", query={"runId", "jobId", "project", "limit"}),
        _route(ControlPathId.AGENT_MEMORY_MAINTENANCE_TRIGGER, ControlMethod.POST, "/api/agent/memory-maintenance", "/control/v1/agent/memory-maintenance", body={"project", "ownerKind", "ownerId", "instruction", "manual", "maxSources"}),
        ...
        _route(ControlPathId.KNOWLEDGE_EMBEDDING_PROFILE, ControlMethod.GET, "/api/knowledge-bases/embedding-profile", None),
        _route(ControlPathId.KNOWLEDGE_EMBEDDING_PROBE, ControlMethod.POST, "/api/knowledge-bases/embedding-probe", None, body={"profile"}, required_body={"profile"}),
        _route(ControlPathId.KNOWLEDGE_EMBEDDING_IMPACT, ControlMethod.POST, "/api/knowledge-bases/embedding-impact", None, body={"profile"}, required_body={"profile"}),
