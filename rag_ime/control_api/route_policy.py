...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.OBSERVABILITY_TRACE_DIAGNOSTIC_REPORT_REPAIR_VERIFY, ControlMethod.POST, "/api/observability/trace-diagnostic-reports/{reportId}/repair-verify", None, params=_OBSERVABILITY_TRACE_DIAGNOSTIC_REPORT, body={"expectedRevision", "repairReceiptId"}, required_body={"expectedRevision", "repairReceiptId"}),
