...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.AGENT_SESSION_SNAPSHOT, ControlMethod.GET, "/api/agent/sessions/{sessionId}/messages", "/control/v1/agent/sessions/{sessionId}/snapshot", scopes=[ControlScope.AGENT_READ], remote_safe=True, params=_SESSION, query={"eventLimit", "beforeEventId", "turnLimit", "beforeMessageId"}, remote_query={"eventLimit", "beforeEventId", "turnLimit", "beforeMessageId"}),
        ...
        _route(ControlPathId.AGENT_ROOM_MESSAGE, ControlMethod.POST, "/api/agent/rooms/{roomId}/messages", "/control/v1/agent/rooms/{roomId}/messages", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"message", "clientMessageId", "participantIds", "workItemId", "attachmentIds", "answerKind", "answerToPostId", "answerToRootId"}, required_body={"message"}, remote_body={"message", "clientMessageId", "participantIds", "workItemId", "attachmentIds", "answerKind", "answerToPostId", "answerToRootId"}, remote_required_body={"message", "clientMessageId"}),
