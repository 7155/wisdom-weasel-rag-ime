...
def default_route_policy() -> ControlRoutePolicy:
    routes = [
        ...
        _route(ControlPathId.AGENT_ROOM_KERNEL_SETTLE, ControlMethod.POST, "/api/agent/rooms/{roomId}/kernel/settle", "/control/v1/agent/rooms/{roomId}/kernel/settle", scopes=[ControlScope.AGENT_WRITE], remote_safe=True, params=_ROOM, body={"settleReceipt", "commit", "invocationReceiptId"}, required_body={"settleReceipt", "commit"}, remote_body={"settleReceipt", "commit", "invocationReceiptId"}, remote_required_body={"settleReceipt", "commit"}),
