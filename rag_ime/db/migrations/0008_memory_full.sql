...
CREATE INDEX IF NOT EXISTS idx_memory_items_project_app ON memory_items(project, app);
...
CREATE INDEX IF NOT EXISTS idx_memory_tag_edges_src ON memory_tag_edges(src_tag_id, weight DESC);
...
CREATE INDEX IF NOT EXISTS idx_memory_atoms_scope ON memory_atoms(scope_project, scope_app);
