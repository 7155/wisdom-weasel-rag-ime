...
CREATE INDEX IF NOT EXISTS idx_memory_books_type_key ON memory_books(book_type, book_key);
CREATE INDEX IF NOT EXISTS idx_memory_books_project_app ON memory_books(project, app);
