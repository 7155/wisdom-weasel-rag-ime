ALTER TABLE agent_subagent_events RENAME TO agent_subagent_events_before_unbounded_counts;

ALTER TABLE agent_subagent_runs RENAME TO agent_subagent_runs_before_unbounded_counts;
...
SELECT
    ...
    max_duration_ms, max_output_chars, turn_count, tool_count, total_tokens,
    result_json, error, created_at_ms, started_at_ms, updated_at_ms, completed_at_ms
FROM agent_subagent_runs_before_unbounded_counts;
...
FROM agent_subagent_events_before_unbounded_counts;

DROP TABLE agent_subagent_events_before_unbounded_counts;
DROP TABLE agent_subagent_runs_before_unbounded_counts;
