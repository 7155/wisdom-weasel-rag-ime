ALTER TABLE agent_message_media RENAME TO agent_message_media_v96;
ALTER TABLE agent_media RENAME TO agent_media_v96;
...
INSERT INTO agent_media(
    ...
    thumbnail_media_id, origin, origin_tool, origin_receipt_id, created_at_ms
)
SELECT
    media_id, session_id, file_name, storage_name, mime_type,
    byte_size, sha256, width, height, duration_ms,
    thumbnail_media_id, origin, origin_tool, origin_receipt_id, created_at_ms
FROM agent_media_v96;
...
FROM agent_message_media_v96;

DROP TABLE agent_message_media_v96;
DROP TABLE agent_media_v96;

CREATE INDEX idx_agent_media_session_recent
ON agent_media(session_id, created_at_ms DESC);

CREATE INDEX idx_agent_media_session_sha
