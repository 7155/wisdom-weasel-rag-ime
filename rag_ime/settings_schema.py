...
SETTINGS_SCHEMA: dict[str, object] = {
    ...
    "sections": [
        ...
        },
        {
            ...
            "label": "本机即时预测",
            "fields": [
                {"key": "models.hot", "type": "string", "label": "本机预测配置 ID", "default": "minimind_ime_v2"},
            ],
        },
        {
            "id": "activeRag",
        ...
        },
        {
            ...
            "fields": [
                ...
                {"key": "memory.automaticOrganization.model", "type": "string", "label": "DeepSeek V4 自动整理模型 ID", "default": "deepseek-v4-flash"},
                ...
                {"key": "memory.dreaming.model", "type": "string", "label": "DeepSeek V4 做梦模型 ID", "default": "deepseek-v4-flash"},
...
_FIELD_METADATA: dict[str, dict[str, object]] = {
    ...
    "models.hot": {
        "description": "选择本机 MLX 预测器注册表中的配置 ID；它不是 Pi Provider 模型",
    ...
    "memory.automaticOrganization.model": {
        "description": "DeepSeek 专用记忆整理器下一次使用的 V4 模型 ID；当前不是通用 Pi 模型槽位",
        "applyMode": "next_maintenance_run",
    ...
    "memory.dreaming.model": {
        "description": "DeepSeek 专用记忆整理器下一次做梦使用的 V4 模型 ID；当前不是通用 Pi 模型槽位",
        "applyMode": "next_maintenance_run",
        "validation": "必须是以 deepseek-v4 开头的模型 ID",
    },
