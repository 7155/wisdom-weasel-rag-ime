...
class RuntimeConfigResolver:
    ...
    def resolve(self, *, settings: Mapping[str, object] | None = None) -> RuntimeConfigSnapshot:
        ...
        post_commit = PostCommitRuntimeConfig(
            ...
            idle_trigger_ms=_bounded_int(post_commit_settings.get("idleTriggerMs"), 420, 40, 3000),
            min_delta_chars=_bounded_int(post_commit_settings.get("minDeltaChars"), 8, 1, 32),
            max_calls_per_10s=_bounded_int(post_commit_settings.get("maxCallsPer10s"), 2, 0, 10),
            cooldown_ms=_bounded_int(post_commit_settings.get("cooldownMs"), 2500, 0, 10000),
            ...
            panel_ttl_ms=_bounded_int(post_commit_settings.get("panelTtlMs"), 2800, 500, 15000),
