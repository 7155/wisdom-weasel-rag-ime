"""Shared Pi configuration values, errors and wire-value coercion.

Configuration, Host communication and public projections import these values
without depending on an executor implementation. __all__ defines the checked
...
class PiRuntimeError(AgentRuntimeError):
    """Failure from managed Pi configuration, Host execution or projection."""
