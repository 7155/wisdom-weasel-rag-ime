...
class PawosRequirementStatusTests(unittest.TestCase):
    def test_repository_split_ledger_covers_ur_001_through_ur_241_with_six_scoped_closeouts(self) -> None:
        ...
        self.assertEqual(report["requirementCount"], 241)
        self.assertEqual(report["firstRequirementId"], "UR-001")
        self.assertEqual(report["lastRequirementId"], "UR-241")
        self.assertEqual(report["assessmentCounts"], {"complete": 6, "unassessed": 235})
        self.assertTrue(report["splitLedger"])
        self.assertEqual(report["completeCount"], 6)
        self.assertEqual(report["receiptCount"], 7)
