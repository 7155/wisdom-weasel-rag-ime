...
class PawosRequirementStatusTests(unittest.TestCase):
    def test_repository_split_ledger_covers_ur_001_through_ur_207_with_three_scoped_closeouts(self) -> None:
        ...
        self.assertEqual(report["requirementCount"], 207)
        self.assertEqual(report["firstRequirementId"], "UR-001")
        self.assertEqual(report["lastRequirementId"], "UR-207")
        self.assertEqual(report["assessmentCounts"], {"complete": 3, "unassessed": 204})
