...
class MemoryGraphReadTests(unittest.TestCase):
    ...
    def test_entity_pages_connections_and_members_independently(self) -> None:
        ...
        self.assertEqual(book["topicPage"]["sections"]["current"][0]["id"], "atom:visible")
        self.assertEqual(book["topicPage"]["sections"]["current"][0]["sourceStatus"], "unavailable")
        self.assertEqual(book["topicPage"]["coverage"]["omittedAtomCount"], 1)
