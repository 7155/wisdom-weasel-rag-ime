...
from rag_ime.control_api import AgentKernelControlFacade, control_route_catalog
...
class ControlApiTests(unittest.TestCase):
    def test_bootstrap_is_frontend_neutral_and_redacts_runtime_errors(self) -> None:
        facade = AgentKernelControlFacade(
            agent=_Agent(),
        ...
        self.assertEqual(payload["schemaVersion"], "rag-ime.agent-control-bootstrap.v1")
