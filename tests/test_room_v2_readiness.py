...
from rag_ime.agent_service import _room_kernel_mode_from_environment
...
class RoomV2ReadinessTests(unittest.TestCase):
    def test_clean_upgrade_from_65_to_82(self) -> None:
        with tempfile.TemporaryDirectory(prefix="room-v2-upgrade-") as directory:
            ...
            self.assertEqual(upgraded.current_version, 82)
            self.assertEqual(
    ...
    def test_all_118_contract_sources_have_stable_hashes(self) -> None:
        ...
        self.assertEqual(len(hashes), 118)
