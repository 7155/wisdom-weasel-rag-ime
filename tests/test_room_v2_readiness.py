...
class RoomV2ReadinessTests(unittest.TestCase):
    def test_clean_upgrade_from_65_to_86(self) -> None:
        with tempfile.TemporaryDirectory(prefix="room-v2-upgrade-") as directory:
            ...
            with closing(sqlite3.connect(":memory:")) as conn:
                ...
                self.assertEqual(upgraded.current_version, 86)
                self.assertEqual(
    ...
    def test_all_122_contract_sources_have_stable_hashes(self) -> None:
        ...
        self.assertEqual(len(hashes), 122)
