...
- Supported diff operations now include `add_stable_memory`, `add_phrase`,
  `tombstone`, and `downrank`. `downrank` is generated by the local-rule
  provider for repeated negative feedback and is intentionally reviewable and
  rollbackable.
