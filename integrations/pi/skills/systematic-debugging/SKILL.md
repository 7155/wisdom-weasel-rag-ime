...
8. Re-run the reproduction, add or identify regression protection, verify the proportional real path, and remove temporary instrumentation.
9. Update the owned worker document with material observations, eliminated hypotheses, confirmed cause, and evidence.
